...
describe("Theme", () => {
  describe("LightGraphTheme", () => {
    test("should have all required color properties", () => {
      expect(LightGraphTheme.primary).toBe("#014785");
      expect(LightGraphTheme.primaryLight).toBe("#476b9f");
      expect(LightGraphTheme.primaryExtraLight).toBe("#7189b7");
  ...
  describe("primaryTheme", () => {
    ...
    test("should have correct token values", () => {
      ...
      expect(primaryTheme.token.colorTextDisabled).toBe(
        LightGraphTheme.textDisabled
      );
      expect(primaryTheme.token.colorBgContainerDisabled).toBe(
        LightGraphTheme.colorBgContainerDisabled
      );
    });
    ...
    test("should have correct Button configuration", () => {
      ...
      expect(primaryTheme.components.Button.primaryColor).toBe(
        LightGraphTheme.white
      );
      expect(primaryTheme.components.Button.defaultColor).toBe("#333333");
      expect(primaryTheme.components.Button.colorLink).toBe(
        LightGraphTheme.primary
      );
      expect(primaryTheme.components.Button.colorLinkHover).toBe(
        LightGraphTheme.primary
      );
    });
  });
  ...
  describe("darkTheme", () => {
    ...
    test("should have correct token values", () => {
      ...
      expect(darkTheme.token.colorTextDisabled).toBe(
        LightGraphTheme.textDisabled
      );
      expect(darkTheme.token.colorBgContainerDisabled).toBe(
        LightGraphTheme.colorBgContainerDisabledDark
      );
    });
    ...
    test("should have correct Menu configuration", () => {
      ...
      expect(darkTheme.components.Menu.itemSelectedColor).toBe(
        LightGraphTheme.primaryExtraLight
      );
    });

    test("should have correct Button configuration", () => {
      expect(darkTheme.components.Button.borderRadius).toBe(4);
      expect(darkTheme.components.Button.primaryColor).toBe(
        LightGraphTheme.white
      );
      expect(darkTheme.components.Button.defaultColor).toBe(
        "var(--ant-color-text-base)"
      );
      expect(darkTheme.components.Button.colorLink).toBe(
        LightGraphTheme.primaryLight
      );
      expect(darkTheme.components.Button.colorLinkHover).toBe(
        LightGraphTheme.primaryLight
      );
    });
  });
