...
import CreateEditBackend from '#/pages/create-backend/CreateEditBackend';
import { useGetBackendQuery, useEditBackendMutation, EditBackendPayload } from '#/lib/store/slice/apiSlice';
...
const EditBackendPage: React.FC = () => {
  ...
  const { data: backends, isLoading: isBackendLoading, isError: isBackendError } = useGetBackendQuery(null);

  const currentBackend = backends?.find((b: Backend) => b.Identifier === backendId);

  // Handle form submission for editing
  const handleEditSubmit = async (values: Omit<EditBackendPayload, 'Identifier'>) => {
    try {
